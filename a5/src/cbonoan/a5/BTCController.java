...
public class BTCController {
    ...
    @FXML
    LineChart<String, Number> priceChartBTC;
    ...
    public void initialize() {
        ...
        series.getData().add(new XYChart.Data<>("3-20", 15321.03));
        series.getData().add(new XYChart.Data<>("4-20", 14254.20));
        series.getData().add(new XYChart.Data<>("5-20", 10826.18));
        series.getData().add(new XYChart.Data<>("6-20", 10639.22));
        series.getData().add(new XYChart.Data<>("7-20", 10158.79));
        ...
        priceChartBTC.getData().add(series);
    }
